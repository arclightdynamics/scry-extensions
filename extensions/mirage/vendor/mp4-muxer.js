/*!
 * mp4-muxer v5.1.3 — https://github.com/Vanilagy/mp4-muxer
 * Copyright (c) Vanilagy. MIT License.
 * Vendored verbatim into Mirage (Scry extension) so frame-exact WebCodecs
 * export works offline with no network or build step. Exposes global `Mp4Muxer`.
 */
"use strict";
var Mp4Muxer = (() => {
